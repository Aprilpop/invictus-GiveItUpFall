Shader "Arany/Separeted/Diffuse_Fog_Emmision" {
	Properties {
...
// Upgrade NOTE: excluded shader from OpenGL ES 2.0 because it uses non-square matrices
			...
			float _Tog;
			uniform float4 _PaletteColors[11];
			...
			fixed4 frag( vertexOutput i ): COLOR {
				...
				fixed4 tex =  tex2D( _MainTex, i.tex.xy)  * i.color *_PaletteColors[_Tog];
				tex.rgb *= _ColorMulti ;
			/*	fixed4 c = _PaletteColors[_Tog];
				tex.rgb = c.rgb ;*/
