Shader "Arany/Separeted/Diffuse_Fog_ColorAdj_AlphaTest" {
	Properties {
	...
	SubShader {
		Pass{
			Tags { "LightMode" = "ForwardBase" "Queue"="Geometry" "RenderType"="TransparentCutout"}
