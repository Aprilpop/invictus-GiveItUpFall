Shader "Arany/Separeted/Diffuse_UnLit_pow" {
	Properties {
...
// Upgrade NOTE: excluded shader from OpenGL ES 2.0 because it uses non-square matrices
		...
		//#pragma multi_compile __ GLOBAL_FOG
			...
			uniform float _ColorMulti, _Pow;
			...
			fixed4 frag( vertexOutput i ): COLOR {
				...
				fixed4 tex = _Color * tex2D( _MainTex, i.tex.xy) * i.color ;
				tex.rgb = pow(  tex.rgb * _ColorMulti, _Pow );
		
				//tex.rgb = pow(tex.rgb, _ColorMulti);
